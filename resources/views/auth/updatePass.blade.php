    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                {!! Form::model($usuario, [ 'action' => ['UsuarioController@store'],'id'=>'formCompetencia', 'onsubmit'=>"return validarForm(this)"]) !!}
                        @csrf
                        ...
                        <div class="form-group row">
                            <label for="email" class="col-md-4 col-form-label text-md-right">{{ __('Repetir Contraseña') }}</label>
                            <div class="col-md-6">

                                    {!! Form::password('contrasena2', ['class' => 'form-control', 'required']) !!}
                            </div>
                        </div>
